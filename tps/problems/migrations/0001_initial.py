    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="posting date"
                    ),
                ),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code_name",
                    models.CharField(
                        db_index=True, max_length=150, verbose_name="code name"
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(verbose_name="task type parameters"),
                ),
                (
                    "score_type",
                    models.CharField(max_length=150, verbose_name="score type"),
                ),
                (
                    "score_type_parameters",
                    models.TextField(verbose_name="score type parameters"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "_input_generation_command",
                    models.TextField(
                        blank=True,
                        max_length=1,
                        null=True,
                        verbose_name="input generation command",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="+",
                        to="file_repository.File",
                        verbose_name="input uploaded file",
                    ),
                ),
                (
                    "_output_file",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "_validate_all_subtasks",
                    models.BooleanField(
                        help_text="if marked, it validates all subtasks",
                        verbose_name="all subtasks",
                    ),
                ),
                (
                    "_subtasks",
                    models.ManyToManyField(
                        to="problems.Subtask", verbose_name="subtasks"
                    ),
                ),
                (
                    "code",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="subtasks", to="problems.TestCase"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="subtask_scores",
            field=models.ManyToManyField(
                through="problems.SolutionSubtaskScore", to="problems.Subtask"
            ),
        ),
        migrations.AddField(
            model_name="solution",
            name="tests_scores",
            field=models.ManyToManyField(
                through="problems.SolutionTestScore", to="problems.TestCase"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="problem",
            field=models.ForeignKey(
                on_delete=models.CASCADE, to="problems.ProblemRevision"
            ),
        ),
        migrations.AddField(
            model_name="problem",
        ...
        migrations.AddField(
            ...
            name="problem",
            field=models.ForeignKey(
                on_delete=models.CASCADE, to="problems.Problem", verbose_name="problem"
            ),
        ),
        migrations.AddField(
