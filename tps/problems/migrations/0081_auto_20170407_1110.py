    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    core.fields.EnumField(
                        default="judging",
                        enum=problems.models.enums.SolutionRunVerdict,
                        max_length=21,
                ...
                (
                    "task_id",
                    models.CharField(max_length=128, null=True, verbose_name="task id"),
                ),
                (
                    "execution_message",
                    models.TextField(null=True, verbose_name="execution message"),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        null=True, verbose_name="solution execution time"
                    ),
                ),
                (
                    "solution_memory_usage",
                    models.IntegerField(
                        null=True, verbose_name="solution memory usage"
                    ),
                ),
                (
                    "checker_standard_error",
                    models.ForeignKey(
                        null=True,
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False, verbose_name="compilation finished"
            ),
        ),
        migrations.AddField(
            model_name="checker",
            ...
            field=models.CharField(
                max_length=128, null=True, verbose_name="compilation task id"
            ),
        ),
        migrations.AddField(
            model_name="inputgenerator",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                max_length=128, null=True, verbose_name="generation task id"
            ),
        ),
        migrations.AddField(
            model_name="validator",
