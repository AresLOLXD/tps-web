...
__all__ = [
    ...
    "ValidatorAddView",
    "ValidatorDeleteView",
    "ValidatorShowSourceView",
    "ValidatorDownloadView",
]
...
class ValidatorsListView(RevisionObjectView):
    def get(self, request, problem_code, revision_slug):
        ...
        return render(
            request,
            "problems/validator_list.html",
            context={"validators": validators, "resources": resources},
        )
...
class ValidatorDownloadView(ProblemObjectDownloadView):
    def get_file(self, request, *args, **kwargs):
        return get_git_object_or_404(
            Validator, pk=kwargs.get("validator_id"), problem=self.revision
        ).file.file
